            ...
            <div className='bg-gradient-to-r from-cyan-800 to-cyan-950 text-white py-16 text-center mx-2 rounded-xl'>
                ...
                <div className='flex items-center justify-between bg-white rounded text-grey-600 max-w-xl pl-4 mx-4 sm:mx-auto'>
                    <div className='flex items-center'>
                        ...
                        <input type="text" placeholder='Search for Jobs' className='max-sm:text-xs text-black p-2 rounded outline-none w-full' ref={titleRef} />
                    </div>
                    <div className='flex items-center'>
                        <img className='h-4 sm:h-5' src={assets.location_icon} alt="" />
                        <input type="text" placeholder='Location' className='max-sm:text-xs text-black p-2 rounded outline-none w-full' ref={locationRef} />
                    </div>
